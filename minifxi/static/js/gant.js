...
function MdlTabHtml(myObj) {
	...
	var modal_html = '<tr><td style="text-align:center; background:' + myObj['pet_col'] + ';" class="let-somb"><b>' + myObj['pet_nom'] + '</b></td></tr>' +
		...
		'<tr><td>Se estimó en <b>' + myObj['est_sum'] + 'h</b>, se planificó en gant <b>' + myObj['gnt_pla'] + 'h</b>, en task <b>' + myObj['tsk_pla'] +
		'h</b> y se ha incurrido <b>' + myObj['tsk_inc'] + 'h</b>, horas acuerdo <b>' + myObj['req_hac'] + 'h</b> y <b>ETC</b> en <b>' + myObj['etc'] + 'h</b>.   </td></tr>' +

		'<tr><td><b>' + myObj['est_cnt'] + '</b> tareas de estimación, <b>' + myObj['tsk_cnt'] + '</b> tareas en task y <b>' + myObj['gnt_cnt'] + '</b> tareas planificadas en gant.</td></tr>';
